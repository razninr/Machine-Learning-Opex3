...
#loaded_model= pickle.load(open('https://github.com/razninr/Machine-Learning-Opex3/blob/main/trained_model.sav', 'rb'))
...
file_path = "https://github.com/razninr/Machine-Learning-Opex3/blob/main/trained_model.sav"
